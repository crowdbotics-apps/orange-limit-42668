"""
Django settings for orange_limit_42668 project.
...
ROOT_URLCONF = 'orange_limit_42668.urls'
...
WSGI_APPLICATION = 'orange_limit_42668.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "orange_limit_42668 API",
    "DESCRIPTION": "API documentation for orange_limit_42668 App",
    "VERSION": "v1",
}
